...
2. Obtain the 'RZERO reading'  and 'PPM CO2 reading' values on the street, yard or outside not in other room at least 1-2 hours<br/>
3. If the values above are stable, then press button named 'Calibrate Sensor' and wait until 'CO₂ level' value are stable<br/>
4. Move esp32 to living room. CO₂ level values displays relativly Air Quality from outside air quailty  tp living rooms values.<br/>
5. To reset to factöry setings, press 'Return to Factory settings' button. And needs re-calibrate sensor<br/>
